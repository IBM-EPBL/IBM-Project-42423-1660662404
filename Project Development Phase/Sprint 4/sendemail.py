...
def sendgridmail(user,TEXT):
    sg = sendgrid.SendGridAPIClient('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')
    from_email = Email("speararul@gmail.com")  # Change to your verified sender
